...
public class MaiaInterface extends NoCGenerationGUI implements ActionListener{
	...
	private void addComponents(){
		...
		//routing algorithm
		y=y+63;
		String[] availableAlgorithm = {
			"XY",
			"West-First Non-Minimal", 
			"North-Last Non-Minimal", 
			"Negative-First Non-Minimal", 
			"West-First Minimal", 
			"North-Last Minimal", 
			"Negative-First Minimal",
			"Odd-Even Minimal"};
		...
		else if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmOEM"))
			selectedAlgorithm = "Odd-Even Minimal";
	...
	public String getRoutingAlgorithmSelected(){
		...
		else if(algorithm.equalsIgnoreCase("Odd-Even Minimal"))
			return "AlgorithmOEM";
		return "AlgorithmXY";
	}
